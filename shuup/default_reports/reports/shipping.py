...
class ShippingReport(OrderReportMixin, ShuupReportBase):
    ...
    def get_objects(self):
        ...
        orders = super(ShippingReport, self).get_objects().filter(filters)[:self.report_limit]
        ...
        return order_lines.select_related(
            ...
            "quantity"
        ).order_by("order__shipping_method__carrier_id", "order__shipping_method_id")[:self.report_limit]
